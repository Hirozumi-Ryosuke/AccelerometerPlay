package com.example.accelerometerplay
...
class MainActivity : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mWakeLock = mPowerManager!!.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, javaClass
                .name)
    ...
    internal inner class SimulationView(context: Context?) : FrameLayout(context!!), SensorEventListener {
                ...
                while (k < NUM_MAX_ITERATIONS && more) {
                    ...
                    for (i in 0 until count) {
                        ...
                        for (j in i + 1 until count) {
                            ...
                            if (dd <= SimulationView.Companion.sBallDiameter2) {
                                /*
                                ...
                                val c = 0.5f * (SimulationView.Companion.sBallDiameter - d) / d
                                val effectX = dx * c
                                val effectY = dy * c
                                curr.mPosX -= effectX
                                curr.mPosY -= effectY
        ...
        override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
            ...
            mHorizontalBound = (w / mMetersToPixelsX - Companion.sBallDiameter) * 0.5f
            mVerticalBound = (h / mMetersToPixelsY - Companion.sBallDiameter) * 0.5f
        }
        ...
        init {
            ...
            mDstWidth = (Companion.sBallDiameter * mMetersToPixelsX + 0.5f).toInt()
            mDstHeight = (Companion.sBallDiameter * mMetersToPixelsY + 0.5f).toInt()
